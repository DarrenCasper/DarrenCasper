...
### 🤖 AI Anime Assistant
A web-based anime assistant that helps users search for anime, get recommendations, view anime details, and interact with an AI-powered anime chat experience.

**Tech used:** JavaScript, Node.js, Express, API Integration  
🔗 Repository: [AI-Anime-Assistant](https://github.com/DarrenCasper/AI-Anime-Assistant)

---

### 🚚 FlexiNode
A smart last-mile delivery demo application that supports alternative pickup nodes, delivery tracking, QR handoff flow, vouchers, and an AI assistant for delivery-related actions.

**Tech used:** Flutter, Dart, Firebase, Maps Integration  
🔗 Repository: [FlexiNode](https://github.com/Kresnananta/FlexiNode)

---

### 🛒 E-Commerce Website
A simple e-commerce website project focused on product display, shopping flow, and frontend development practice.

**Tech used:** JavaScript, Web Development  
🔗 Repository: [E-Commerce-Website](https://github.com/DarrenCasper/E-Commerce-Website)

---

### ⏳ Anime Countdown
A countdown website for anime-related schedules with basic functionality and interactive frontend practice.

**Tech used:** JavaScript  
🔗 Repository: [anime-countdown](https://github.com/DarrenCasper/anime-countdown)
...
[![Email](https://img.shields.io/badge/Email-darrendexterthio%40gmail.com-red?style=for-the-badge&logo=gmail&logoColor=white)](mailto:darrendexterthio@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-DarrenCasper-181717?style=for-the-badge&logo=github)](https://github.com/DarrenCasper)
